      ...
      <nav class="navbar navbar-expand-sm bg-dark navbar-dark" >
			<div class="container-fluid d-flex justify-content-between">
			  ...
			  <div class="collapse navbar-collapse">
				<ul class="navbar-nav">
				  <li class="nav-item">
					<a class="nav-link" href="empresa1.html">Home</a>
				  </li>
				  <li class="nav-item dropdown">
					<a class="nav-link dropdown-toggle" href="" data-toggle="dropdown">Colections</a>
					<div class="dropdown-menu">
						<a class="dropdown-item" href="TiendaDin.jsp">Contrastes Urbanos</a>
						<a class="dropdown-item" href="TiendaDin.jsp">Voces Silenciadas</a>
						<a class="dropdown-item" href="TiendaDin.jsp">Realidades Ocultas</a>
					  </div>
				</li>
				  <li class="nav-item">
					<a class="nav-link" href="ubicacion.html">Find Us</a>
				  </li>
				<li class="nav-item">
				  <a class="nav-link" href="SobreNosotros.html">About Us</a>
				</li>  
				</ul>
			  </div>
