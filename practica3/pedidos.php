...
<html lang="es">
    ...
    <body style="background-color: #212529;">
        ...
        <div class="container-fluid">
			<div>
				<h4 style="color: aliceblue; font-family: Roboto Condensed; text-align: center; position: relative; top:10px;">FILTRAR PEDIDOS</h4>			
			</div>
			<div class="container RecPerfil">
					<div class="mb-3 mt-3">
					  <label for="uname" class="form-label"><span class="colorUsername"> Filtrar por usuario:</span></label>
					  <input type="text" class="form-control" placeholder="Codigo Usuario" name="usuario">
					</div>
                    <form method="post" action="pedidosFiltro.php">
