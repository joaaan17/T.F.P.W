    ...
    <mi-menu2></mi-menu2>
		...
		<div class="container-fluid">
			...
			<div class="container RecPerfil">
				<form method="post" action="modificarProd-Control.php">
					<div class="mb-3 mt-3">
					  <label for="uname" class="form-label"><span class="colorUsername"> DESCRIPCION:</span></label>
					  <input type="text" class="form-control" id="uname" placeholder="descripcion" name="descripcion" value="<?php echo isset($_POST['descripcion']) ? htmlspecialchars($_POST['descripcion']) : ''; ?>" required>
					  <div class="valid-feedback">Valid.</div>
					  <div class="invalid-feedback">Please fill out this field.</div>
					</div>
					<div class="mb-3">
					  <label for="pwd" class="form-label"><span class="colorUsername"> PRECIO:</span></label>
					  <input type="text" class="form-control" id="pwd" placeholder="precio" name="precio" value="<?php echo isset($_POST['precio']) ? htmlspecialchars($_POST['precio']) : ''; ?>"required>
					  <div class="valid-feedback">Valid.</div>
					  <div class="invalid-feedback">Please fill out this field.</div>
					</div>
                    <div class="mb-3">
                        <label for="pwd" class="form-label"><span class="colorUsername"> EXISTENCIAS:</span></label>
                        <input type="text" class="form-control" id="pwd" placeholder="existencias" name="existencias" value="<?php echo isset($_POST['existencias']) ? htmlspecialchars($_POST['existencias']) : ''; ?>"required>
                        <div class="valid-feedback">Valid.</div>
                        <div class="invalid-feedback">Please fill out this field.</div>
                    </div>
                    <div class="mb-3">
                        <label for="pwd" class="form-label"><span class="colorUsername"> IMAGEN:</span></label>
                        <input type="text" class="form-control" id="pwd" placeholder="url-imagen" name="imagenURL" value="<?php echo isset($_POST['imagenURL']) ? htmlspecialchars($_POST['imagenURL']) : ''; ?>" required>
                        <div class="valid-feedback">Valid.</div>
                        <div class="invalid-feedback">Please fill out this field.</div>
                    </div>
